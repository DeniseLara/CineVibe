    ...
    <div className="about-container">
      ...
      <section className="about-section">
        ...
        <p className="about-description">
          This project aims to provide users with a quick and easy 
          way to search for movie information, including details such 
          as title, release date, rating, and other relevant aspects.
        </p>
      </section>
        ...
        <ul className="tech-cards">
          <li className="tech-card">
            ...
            <p className='tech-description'>
              Frontend and interactive components.
            </p>
          </li>
          ...
          <li className="tech-card">
            ...
            <p className='tech-description'>
              Modern and optimized functions.
            </p>
          </li>
          ...
          <li className="tech-card">
            ...
            <p className='tech-description'>
              Development and production performance optimization.
            </p>
          </li>
        </ul>
      </section>
      ...
      <section className="about-section">
        ...
        <p className="about-description">
          While integrating the TMDb API posed some challenges, the biggest 
          hurdles came from designing a clean and responsive layout, as well 
          as ensuring smooth CSS transitions and maintaining performance across 
          devices. Adapting the navigation to work seamlessly on both mobile and 
          desktop screens required careful attention to detail, particularly in making
